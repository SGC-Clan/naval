...
namespace Sandbox
{
	public partial class NavalWaterSceneObject
	{
		public class RippleCompute
		{
			internal NavalWaterSceneObject Water;
			...
			public RippleCompute( NavalWaterSceneObject parent )
			{
				Water = parent;
			...
			public void Update()
			{
				...
				if( Water.RenderBounds.Size.x > Radius * 2 && Water.RenderBounds.Size.y > Radius * 2 )
				{
			...
			internal void SendAttributes()
			{
				...
				compute.Attributes.Set( "WaterHeight",		Math.Max( Water.RenderBounds.Mins.z, Water.RenderBounds.Maxs.z ) );
